...
const ListUserReceiveComplimentsService_1 = require("../service/ListUserReceiveComplimentsService");
class ListUserReceiveComplimentsController {
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const compliments = yield listUserReceiveComplimentsService.execute(user_id);
