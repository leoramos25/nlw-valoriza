...
class ListUserSendComplimentsService {
    execute(user_id) {
        return __awaiter(this, void 0, void 0, function* () {
            const complimentRepositories = typeorm_1.getCustomRepository(ComplimentsRepositories_1.ComplimentsRepositories);
            const compliments = yield complimentRepositories.find({
                where: {
                    user_sender: user_id
                },
